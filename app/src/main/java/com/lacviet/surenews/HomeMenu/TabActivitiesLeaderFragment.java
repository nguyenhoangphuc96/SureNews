...
public class TabActivitiesLeaderFragment extends Fragment {
    ...
    private void addData() {
        listNews.add(new NewsModel(1,
                ...
                baseSrcUrl+"/PublishingImages/khoi%20cong%20bv%20da%20khoa2562018_164113.jpg"));
        listNews.add(new NewsModel(2,
                "Đại hội Đại biểu Liên hiệp các Hội Khoa học và Kỹ thuật tỉnh Bạc Liêu khóa IV, nhiệm kỳ 2018 - 2023",
                "Thứ Hai, 25/06/2018, 09:25",
                "Đại hội Đại biểu Liên hiệp các Hội Khoa học và Kỹ thuật tỉnh Bạc Liêu (LHH)khóa IV, nhiệm kỳ 2018 - 2023 đã được tổ chức vào ngày 08/6 tại nhà khách số 01 Hùng Vương (thành phố Bạc Liêu).",
                baseSrcUrl+"/PublishingImages/dai%20hoi%20dai%20bieu1162018_933.jpg"));
        listNews.add(new NewsModel(3,
                ...
                baseSrcUrl+"/PublishingImages/dai%20hoi%20cong%20doan2562018_103755.jpg"));
    ...
    private void addControl(View view) {
        recyclerView = view.findViewById(R.id.rcvTabActivitiesLeader);
        pbTabhome =view.findViewById(R.id.pbTabActivitiesLeader);
    }
    ...
    private void startDetailActivity(int id, String title, String time, String subTitle) {
        Intent intent = new Intent(getContext(), DetailActivitiesLeaderActivity.class);
