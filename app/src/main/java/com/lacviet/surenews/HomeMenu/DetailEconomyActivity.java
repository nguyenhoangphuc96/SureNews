...
public class DetailEconomyActivity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    private void addSamenews() {
        layoutSameNews = LayoutInflater.from(DetailEconomyActivity.this).inflate(R.layout.view_same_news, loBody, false);
    ...
    private void initData() {
        switch (id) {
            ...
            case 3: {
                listDetailHome3.add(baseSrcUrlNew+"/PublishingImages/dinh%20huong%20thanh%20lap%20htx2562018_104544.jpg");
    ...
    private void loadDataById(ArrayList<String> listDetailHome) {
        ...
        for(int i = 0; i<listDetailHome.size()-1;i++)
        {
            if (listDetailHome.get(i).startsWith("http")) {
                layoutImage = LayoutInflater.from(DetailEconomyActivity.this).inflate(R.layout.item_image, loBody, false);
                ...
                Picasso.with(DetailEconomyActivity.this).load(image).into(imgView);

                loBody.addView(layoutImage);
                i++;

            } else {
                layoutText = LayoutInflater.from(DetailEconomyActivity.this).inflate(R.layout.item_text, loBody, false);
        ...
        //author
        layoutAuthor = LayoutInflater.from(DetailEconomyActivity.this).inflate(R.layout.item_text, loBody, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_speak: {
                ...
                if (!isClickSpeak) {
                    textToSpeech = new TextToSpeech(DetailEconomyActivity.this, new TextToSpeech.OnInitListener() {
                        @Override
