...
public class TabEconomyFragment extends Fragment {
    ...
    private void addControl(View view) {
        recyclerView = view.findViewById(R.id.rcvTabEconomy);
        pbTabhome =view.findViewById(R.id.pbTabEconomy);
    }
    ...
    private void startDetailActivity(int id, String title, String time, String subTitle) {
        Intent intent = new Intent(getContext(), DetailEconomyActivity.class);
