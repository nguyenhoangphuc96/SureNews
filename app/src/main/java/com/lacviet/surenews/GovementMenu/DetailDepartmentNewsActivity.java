    ...
    private void loadDataById(ArrayList<String> listDetailHome) {
        ...
        for (int i = 0; i < listDetailHome.size(); i++) {
            if (listDetailHome.get(i).startsWith("http://")) {
                View layout2 = LayoutInflater.from(DetailDepartmentNewsActivity.this).inflate(R.layout.item_image, loBody, false);
                ...
                View layout1 = LayoutInflater.from(DetailDepartmentNewsActivity.this).inflate(R.layout.item_text, loBody, false);
