...
public class DetailDepartmentNewsActivity extends AppCompatActivity {
    ...
    private void addSamenews() {
        layoutSameNews = LayoutInflater.from(DetailDepartmentNewsActivity.this).inflate(R.layout.view_same_news, loBody, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_speak: {
                ...
                if (!isClickSpeak) {
                    textToSpeech = new TextToSpeech(DetailDepartmentNewsActivity.this, new TextToSpeech.OnInitListener() {
                        @Override
