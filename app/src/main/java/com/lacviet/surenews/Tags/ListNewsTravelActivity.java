...
import com.lacviet.surenews.TravelMenu.DetailTravelActivity;
...
public class ListNewsTravelActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        mService.getAllTravelNewsByTag(categoryId,tag,1,10).enqueue(new Callback<AllNewsJsonResponse>() {
            @Override
            public void onResponse(Call<AllNewsJsonResponse> call, Response<AllNewsJsonResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(ListNewsTravelActivity.this, "Error" + statusCode + response.message(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<AllNewsJsonResponse> call, Throwable t) {
                Toast.makeText(ListNewsTravelActivity.this, "Vui lòng kiểm tra kết nối!", Toast.LENGTH_SHORT).show();
    ...
    private void startDetailActivity(String id, String categoryId) {
        Intent intent = new Intent(ListNewsTravelActivity.this, DetailTravelActivity.class);
