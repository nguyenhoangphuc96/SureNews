...
public class ListNewsGovermentActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        mService.getAllGovermentNewsByTag(categoryId,tag,1,10).enqueue(new Callback<AllNewsJsonResponse>() {
            @Override
            public void onResponse(Call<AllNewsJsonResponse> call, Response<AllNewsJsonResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(ListNewsGovermentActivity.this, "Error" + statusCode + response.message(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<AllNewsJsonResponse> call, Throwable t) {
                Toast.makeText(ListNewsGovermentActivity.this, "Vui lòng kiểm tra kết nối!", Toast.LENGTH_SHORT).show();
    ...
    private void startDetailActivity(String id, String categoryId) {
        Intent intent = new Intent(ListNewsGovermentActivity.this, DetailGovernmentActivity.class);
