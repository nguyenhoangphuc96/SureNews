...
public class DetailPolicyActivity extends AppCompatActivity {
    ...
    private void addSamenews() {
        layoutSameNews = LayoutInflater.from(DetailPolicyActivity.this).inflate(R.layout.view_same_news, loBody, false);
    ...
    private void loadDataById(ArrayList<String> listDetailHome) {
        ...
        for(int i = 0; i<listDetailHome.size()-1;i++)
        {
            if (listDetailHome.get(i).startsWith("http")) {
                layoutImage = LayoutInflater.from(DetailPolicyActivity.this).inflate(R.layout.item_image, loBody, false);
                ...
                layoutText = LayoutInflater.from(DetailPolicyActivity.this).inflate(R.layout.item_text, loBody, false);
        ...
        //author
        layoutAuthor = LayoutInflater.from(DetailPolicyActivity.this).inflate(R.layout.item_text, loBody, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_speak: {
                ...
                if (!isClickSpeak) {
                    textToSpeech = new TextToSpeech(DetailPolicyActivity.this, new TextToSpeech.OnInitListener() {
                        @Override
