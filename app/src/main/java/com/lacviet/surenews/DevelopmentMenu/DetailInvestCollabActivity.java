...
public class DetailInvestCollabActivity extends AppCompatActivity {
    ...
    private void addSamenews() {
        layoutSameNews = LayoutInflater.from(DetailInvestCollabActivity.this).inflate(R.layout.view_same_news, loBody, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_speak: {
                ...
                if (!isClickSpeak) {
                    textToSpeech = new TextToSpeech(DetailInvestCollabActivity.this, new TextToSpeech.OnInitListener() {
                        @Override
