...
public class TabInvestProjectFragment extends Fragment {
    ...
    public TabInvestProjectFragment() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_tab_invest_project, container, false);
        addControl(view);
    ...
    private void addData() {
        listNews.add(new NewsModel(1,
                "Các dự án kêu gọi đầu tư xã hội hóa bức xúc và dự án ưu tiên mời gọi đầu tư trong lĩnh vực dịch vụ-du lịch trên địa bàn tỉnh Bạc Liêu năm 2018",
                "30/06/2018",
                "Tỉnh Bạc Liêu vừa có Quyết định ban hành Danh mục các dự án kêu gọi đầu tư xã hội hóa bức xúc và Danh mục các dự án ưu tiên mời gọi đầu tư trong lĩnh vực dịch vụ - du lịch để phát triển kinh tế - xã hội trên địa bàn tỉnh Bạc Liêu năm 2018.",
                "http://www.baclieu.gov.vn/_layouts/LacVietBIO/fckUpload_BL/SiteChinh/2018-5/cac%20du%20an%20keu%20goi%20dau%20tu2852018_15306.jpg"));
    ...
    private void addControl(View view) {
        recyclerView = view.findViewById(R.id.rcvTabInvestProject);
        pbTabhome = view.findViewById(R.id.pbTabInvestProject);
    }
