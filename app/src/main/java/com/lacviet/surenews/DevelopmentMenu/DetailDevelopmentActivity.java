...
public class DetailDevelopmentActivity extends AppCompatActivity {
    Toolbar toolbar;
        ...
        speedDialView.setOnActionSelectedListener(new SpeedDialView.OnActionSelectedListener() {
            ...
            public boolean onActionSelected(SpeedDialActionItem speedDialActionItem) {
                switch (speedDialActionItem.getId()) {
                    ...
                    case R.id.fab_save: {
                        Toast.makeText(DetailDevelopmentActivity.this,"Chức năng đang phát triển!",Toast.LENGTH_LONG).show();
                        return false; // true to keep the Speed Dial open
                    }
                    case R.id.fab_share: {
                        Toast.makeText(DetailDevelopmentActivity.this,"Chức năng đang phát triển!",Toast.LENGTH_LONG).show();
    ...
    private void startMainActivity() {
        Intent intent = new Intent(DetailDevelopmentActivity.this, MainActivity.class);
        startActivity(intent);
    }

    private void addSamenews() {
        layoutSameNews = LayoutInflater.from(DetailDevelopmentActivity.this).inflate(R.layout.view_same_news, loBody, false);
    ...
    private void getListSameNews(String categoryId) {
        mService.getAllInvestmentNewsByPage(categoryId,1,10).enqueue(new Callback<AllNewsJsonResponse>() {
            @Override
            public void onResponse(Call<AllNewsJsonResponse> call, Response<AllNewsJsonResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(DetailDevelopmentActivity.this, "Error" + statusCode + response.message(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<AllNewsJsonResponse> call, Throwable t) {
                Toast.makeText(DetailDevelopmentActivity.this, "Vui lòng kiểm tra kết nối!", Toast.LENGTH_SHORT).show();
    ...
    private void loadListContentById(String id, final String categoryId) {
        mService.getDetailInvestMent(id,categoryId).enqueue(new Callback<DetailJsonResponse>() {
            @Override
    ...
    private void loadContent(List<ContentModel> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).getType() == 2) {
                layoutImage = LayoutInflater.from(DetailDevelopmentActivity.this).inflate(R.layout.item_image, loBody, false);
                ...
                Picasso.with(DetailDevelopmentActivity.this).load(image).into(imgView);

                loBody.addView(layoutImage);
                i++;

            } else {
                layoutText = LayoutInflater.from(DetailDevelopmentActivity.this).inflate(R.layout.item_text, loBody, false);
        ...
        //author
        layoutAuthor = LayoutInflater.from(DetailDevelopmentActivity.this).inflate(R.layout.item_text, loBody, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_speak: {
                ...
                if (!isClickSpeak) {
                    textToSpeech = new TextToSpeech(DetailDevelopmentActivity.this, new TextToSpeech.OnInitListener() {
                        @Override
